...
async function testBrokenPlugin() {
  ...
  console.log('📝 Backing up original src/main.ts...');
...
`;
  ...
  try {
    ...
    console.log('💥 Created broken src/main.ts with syntax error...');
